	...
	sectionInfo: [
		{
			...
			pic: 'pic1',
			paragraph:
				'I have built full stack e-commerce website, a mobile application using Flutter, and a procedurally generated puzzle-rpg game.',
			button: 'see projects',
		},
		{
			id: 'three',
			...
			pic: 'pic2',
			paragraph: 'Some of my design work over the years and hobby photography.',
			button: 'see work',
		},
		{
			id: 'four',
